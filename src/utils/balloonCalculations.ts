...
};Let me check the console logs and the database values to understand what's happening.
...
Let me query the `balloonformula` table directly to verify the correct value for 20 ft:

<lov-code>
Let's update the balloonCalculations.ts file to ensure we're getting the correct values from the database:

<lov-write file_path="src/utils/balloonCalculations.ts">
import { supabase } from "@/integrations/supabase/client";
